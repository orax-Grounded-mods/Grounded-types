...
---@field ManageTickWithBlendTriggers boolean
...
---@field bRegisterSceneProxyCulling boolean
---@field bForceOCDV boolean
...
---@field OnPostInitializeComponents FActorOnPostInitializeComponents
...
---@return boolean
function AActor:SetActorRotationNoPhysics(NewRotation) end
...
---@return boolean
function AActor:GetForceOCDV() end
---@param OtherActor AActor
---@return float
...
---@field AnimRootMotionTranslationScale FVector
...
---@class AOverlapCullDistanceVolume : AVolume
---@field bEnabled boolean
---@field GroupName FName
---@field ViewDistanceScale float
AOverlapCullDistanceVolume = {}
...
---@param NewFOV float
function APlayerCameraManager:OnFOVChanged(NewFOV) end
---@return APlayerController
...
---@param IsLeftTrigger boolean
function APlayerController:SetAdaptiveTriggerWeapon(Start, End, Strength, IsLeftTrigger) end
---@param StartPosition uint8
---@param Frequency uint8
---@param Amplitude uint8
---@param IsLeftTrigger boolean
function APlayerController:SetAdaptiveTriggerVibration(StartPosition, Frequency, Amplitude, IsLeftTrigger) end
---@param IsLeftTrigger boolean
function APlayerController:SetAdaptiveTriggerOff(IsLeftTrigger) end
---@param StartPosition uint8
---@param EndPosition uint8
---@param StartStrength uint8
---@param EndStrength uint8
---@param IsLeftTrigger boolean
function APlayerController:SetAdaptiveTriggerFeedbackSloped(StartPosition, EndPosition, StartStrength, EndStrength, IsLeftTrigger) end
---@param StartPosition uint8
---@param Strength uint8
---@param IsLeftTrigger boolean
function APlayerController:SetAdaptiveTriggerFeedback(StartPosition, Strength, IsLeftTrigger) end
...
---@return EAdaptiveTriggerMode
function APlayerController:GetActiveAdaptiveTriggerMode() end
---@param NewFOV float
...
---@field bDisableWhenNoPlayerOverlaps boolean
---@field bCanToggleEnabledAtRunTime boolean
---@field OverlappingLocalPawns TArray<AActor>
APostProcessVolume = {}
...
function APostProcessVolume:OnEndOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex) end
---@param OverlappedComponent UPrimitiveComponent
---@param OtherActor AActor
---@param OtherComp UPrimitiveComponent
---@param OtherBodyIndex int32
...
function APostProcessVolume:OnBeginOverlap(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult) end
...
---@field bDisableTickOnBeginPlay boolean
...
---@class FCullDistancePriorityPair
---@field Priority int32
---@field CullDistance float
FCullDistancePriorityPair = {}
...
---@class FLMUVExcludedTriangleIDs
---@field TriangleIDs TArray<FTriangleID>
FLMUVExcludedTriangleIDs = {}
...
---@field bAllowFarShadowLandscape boolean
---@field bAllowFarShadowFoliage boolean
---@field bAllowFarShadowHLOD boolean
...
---@field LMUVExclusionScale float
...
---@field bExcludeFromLMUV boolean
...
---@class FOverlapCullDistanceIDList
---@field IDs TArray<uint32>
---@field ViewDistances TArray<float>
FOverlapCullDistanceIDList = {}
...
---@field AutoExposureBiasCurveAtlas UCurveFloatAtlas
...
---@class FSceneComponentDeferredUpdatesTickFunction : FTickFunction
FSceneComponentDeferredUpdatesTickFunction = {}
...
---@class FSpringArmTraceCustomParams
---@field AdditionalIgnoreActors TArray<AActor>
FSpringArmTraceCustomParams = {}
...
---@field bAllowAnimNotifies boolean
UAnimInstance = {}
...
---@field bAutoDestroyWhenFollowing boolean
...
---@field bIgnoreUpdateTransformWhenInactive boolean
---@field bAutoManageAttachment boolean
---@field bSkipOcclusionOverride boolean
...
---@field CenterOfBuoyancy float
---@field bStickToSurface boolean
---@field SurfaceMaxVelocityZ float
---@field CenterAboveWaterMaxAccel float
...
---@class UCurveFloatAtlas : UTexture2D
---@field TextureSize uint32
---@field SourceCurve UCurveFloat
UCurveFloatAtlas = {}
...
---@field bGenerateAtmosphereSunLightDisc boolean
...
---@field InscatteringLatLongMap UTextureRenderTarget2D
...
---@param NewValue float
function UExponentialHeightFogComponent:SetStaticLightingScatteringIntensity(NewValue) end
---@param Value float
function UExponentialHeightFogComponent:SetStartDistance(Value) end
---@param Value float
function UExponentialHeightFogComponent:SetSecondaryFogHeightFalloff(Value) end
---@param Value float
function UExponentialHeightFogComponent:SetSecondaryFogDensityOffset(Value) end
---@param Value float
function UExponentialHeightFogComponent:SetSecondaryFogDensity(Value) end
---@param NewValue float
function UExponentialHeightFogComponent:SetOEIFadeHeight(NewValue) end
---@param Value float
...
---@param Value UTextureRenderTarget2D
function UExponentialHeightFogComponent:SetInscatteringLatLongMap(Value) end
---@param Value float
...
---@field FoliageAdvertisements TArray<UInstancedStaticMeshComponent>
...
---@param bSkipOcclusionOverride boolean
---@return UAudioComponent
function UGameplayStatics:SpawnSoundAttached(Sound, AttachToComponent, AttachPointName, Location, Rotation, LocationType, bStopWhenAttachedToDestroyed, VolumeMultiplier, PitchMultiplier, StartTime, AttenuationSettings, ConcurrencySettings, bAutoDestroy, bSkipOcclusionOverride) end
---@param WorldContextObject UObject
---@param Sound USoundBase
---@param Location FVector
---@param Rotation FRotator
...
---@param bSkipOcclusionOverride boolean
function UGameplayStatics:PlaySoundAtLocation(WorldContextObject, Sound, Location, Rotation, VolumeMultiplier, PitchMultiplier, StartTime, AttenuationSettings, ConcurrencySettings, OwningActor, bSkipOcclusionOverride) end
---@param WorldContextObject UObject
---@param Sound USoundBase
---@param VolumeMultiplier float
---@param PitchMultiplier float
...
---@param bTeleport boolean
---@param bMarkNavDirty boolean
---@return boolean
function UInstancedStaticMeshComponent:UpdateInstanceTransform(InstanceIndex, NewInstanceTransform, bWorldSpace, bMarkRenderStateDirty, bTeleport, bMarkNavDirty) end
---@param InstanceIndex int32
...
---@param TextureWidth int32
---@param TextureHeight int32
---@return UTexture2D
function UKismetRenderingLibrary:ImportScreenshotAsTexture2D(Buffer, TextureWidth, TextureHeight) end
---@param WorldContextObject UObject
...
---@field TransmissionFallOffDistance float
---@field bForceHairScattering boolean
ULightComponent = {}
...
---@field bTranslucencyBehindSky boolean
...
---@class UMaterialExpressionHDRReferenceImageExtents : UMaterialExpression
UMaterialExpressionHDRReferenceImageExtents = {}
...
---@class UMaterialExpressionReflectionEnvironmentSample : UMaterialExpression
---@field Position FExpressionInput
---@field RayDirection FExpressionInput
---@field Roughness FExpressionInput
UMaterialExpressionReflectionEnvironmentSample = {}
...
---@class UMaterialExpressionVolumetricLightmapSample : UMaterialExpression
---@field Position FExpressionInput
---@field RayDirection FExpressionInput
UMaterialExpressionVolumetricLightmapSample = {}
...
---@param LayerBlendIndex int32
---@param Value FLinearColor
function UMaterialInstanceDynamic:SetVectorParameterValueWithInfo(ParameterName, Association, LayerBlendIndex, Value) end
...
function UMaterialInstanceDynamic:SetTextureParameterValueWithInfo(ParameterName, Association, LayerBlendIndex, Value) end
---@param ParameterInfo FMaterialParameterInfo
---@param Value UTexture
...
---@param LayerBlendIndex int32
---@param Value float
function UMaterialInstanceDynamic:SetScalarParameterValueWithInfo(ParameterName, Association, LayerBlendIndex, Value) end
---@param ParameterInfo FMaterialParameterInfo
---@param Value float
...
---@param LayerBlendIndex int32
---@return FLinearColor
function UMaterialInstanceDynamic:GetVectorParameterValueWithInfo(ParameterName, Association, LayerBlendIndex) end
---@param ParameterName FName
---@param Association EMaterialParameterAssociation
---@param LayerBlendIndex int32
---@return UTexture
function UMaterialInstanceDynamic:GetTextureParameterValueWithInfo(ParameterName, Association, LayerBlendIndex) end
---@param ParameterName FName
---@param Association EMaterialParameterAssociation
---@param LayerBlendIndex int32
---@return float
function UMaterialInstanceDynamic:GetScalarParameterValueWithInfo(ParameterName, Association, LayerBlendIndex) end
...
---@field bAllowDisableDuringCombatEvents boolean
---@field LODMethod ParticleSystemLODMethod
...
---@field bUnbound boolean
---@field bCanToggleEnabledAtRunTime boolean
---@field bTrackOverlaps boolean
---@field OverlappingLocalPawns TArray<AActor>
UPostProcessComponent = {}

---@param Pawn AActor
function UPostProcessComponent:RemoveOverlappingPawn(Pawn) end
---@param Register boolean
function UPostProcessComponent:RegisterPostProcessComponent(Register) end
---@param Pawn AActor
function UPostProcessComponent:AddOverlappingPawn(Pawn) end
---@param InBlendableObject TScriptInterface<IBlendableInterface>
---@param InWeight float
...
---@field OverrideShadowRadiusModifier float
...
---@field bNeverScreenSizeCull boolean
...
---@field bOccludeSunInRealtimeSkyCapture boolean
---@field bVisibleInRayTracing boolean
...
---@field bMinorShadowCaster boolean
---@field bMobileMinorShadowCaster boolean
...
---@field OverlapCullDistanceVolumeIDs TSet<uint32>
---@field OCDVViewDistanceScale float
...
---@field LightChannels FLightingChannels
...
---@field bEnableGpuOnlyPreExposure boolean
...
---@field bAlwaysRenderShowOnlyActors boolean
...
---@field bAlwaysSkipUpdateOverlaps boolean
---@field bDeferTransformUpdates boolean
---@field bHasTransformUpdateBeenDeferred boolean
---@field DeferredUpdatesTickFunction FSceneComponentDeferredUpdatesTickFunction
---@field bAbsoluteLocation boolean
...
---@field bShouldIgnoreUpdateTransformIfNoMesh boolean
...
---@field bOverrideEndGroup boolean
---@field OverridenEndTickGroup ETickingGroup
...
---@param InSunDiskAngle float
function USkyAtmosphereComponent:SetSunVisibilityDiskAngle(InSunDiskAngle) end
---@param InSunDirection FVector
function USkyAtmosphereComponent:SetSunVisibilityDirection(InSunDirection) end
---@param NewValue FLinearColor
...
---@return float
function USkyAtmosphereComponent:GetSunVisibility() end
...
---@field bRealTimeCaptureTimeSlicing boolean
...
---@field InnerClip float
---@field OuterClip float
USpotLightComponent = {}
...
---@field bUseCustomizeTraceQueryParams boolean
...
---@field AllLMUVExcludedTriangles TArray<FLMUVExcludedTriangleIDs>
---@field LightmapUVDensity float
---@field bOverride_LightMapResolution boolean
---@field LightMapResolution int32
---@field LightmapType ELightmapType
---@field LightMapCoordinateIndex int32
---@field DistanceFieldSelfShadowBias float
---@field BodySetup UBodySetup
---@field SharedCollisionBodySetup UBodySetup
---@field LODForCollision int32
---@field bGenerateMeshDistanceField boolean
---@field bInPlaceDisplacement boolean
---@field bNeverCullPhysics boolean
---@field bIsInvalidWaveAnchor boolean
...
---@field bUseSpecificLODForLightmass boolean
---@field LODForLightmass uint32
---@field bScreenSizeCullFade boolean
---@field bCastScreenSpaceShadows boolean
---@field bInteractableHighlightOcclusion boolean
---@field bAllowCPUAccess boolean
...
---@field bOverrideIsInvalidWaveAnchor boolean
---@field bIsInvalidWaveAnchor boolean
...
---@field bIgnoreTimeDilation boolean
---@field bDisableDuringCombatEvent boolean
---@field bIsDisabledForCombatEvent boolean
UTimelineComponent = {}
