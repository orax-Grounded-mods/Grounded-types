...
---@field bIgnorePressKeyInput boolean
...
---@field OnProposedSelectionChanged FComboBoxStringOnProposedSelectionChanged
---@field OnClosing FComboBoxStringOnClosing
...
function UComboBoxString:OnClosingEvent__DelegateSignature() end
---@return boolean
...
---@param MaxCharCount int32
function UEditableText:SetMaxCharCount(MaxCharCount) end
...
---@field RevertTextOnEscape boolean
---@field ClearKeyboardFocusOnCommit boolean
---@field ClearKeyboardFocusOnEscape boolean
---@field SelectAllTextOnCommit boolean
---@field AllowContextMenu boolean
---@field KeyboardType EVirtualKeyboardType::Type
---@field VirtualKeyboardOptions FVirtualKeyboardOptions
...
---@field OnTextFocusReceived FEditableTextBoxOnTextFocusReceived
---@field OnTextFocusLost FEditableTextBoxOnTextFocusLost
UEditableTextBox = {}

---@param InIgnoreKeyUp boolean
function UEditableTextBox:SetVirtualKeyboardIgnoreKeyUp(InIgnoreKeyUp) end
---@param InText FText
...
function UEditableTextBox:OnEditableTextBoxFocusReceivedEvent__DelegateSignature(InFocusEvent) end
---@param InFocusEvent FFocusEvent
function UEditableTextBox:OnEditableTextBoxFocusLostEvent__DelegateSignature(InFocusEvent) end
---@param Text FText
---@param CommitMethod ETextCommit::Type
...
---@field bFlipForRightToLeftFlowDirection boolean
---@field bHDRReferenceImage boolean
---@field bHDRCalibrationBox boolean
...
---@field bHandleDirectionalNavigation boolean
...
---@return UWidget
function UMenuAnchor:GetContentWidget() end
---@param bFit boolean
...
---@param MaxChars int32
function UMultiLineEditableText:SetMaxCharLimit(MaxChars) end
---@param bReadOnly boolean
...
---@field NarrationVisibility ENarrationVisibility
---@field bVerboseNarration boolean
...
---@return boolean
function UWidget:IsVisibleRecursive() end
---@return boolean
function UWidget:IsVisible() end
---@return boolean
function UWidget:IsInvisibleDueToParentOrSelfVisibility() end
---@return boolean
...
---@field bInvisibleWhenOffScreen boolean
...
function UWidgetComponent:ResetRenderer() end
...
---@return ESlateVisibility
function UWidgetComponent:GetCachedWidgetVisibility() end
