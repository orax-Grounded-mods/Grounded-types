...
ABP_Weed_Dandelion_B_C = {}

function ABP_Weed_Dandelion_B_C:ReceiveBeginPlay() end
---@param DamageInfo FDamageInfo
ABP_Weed_Dandelion_B_C['Handle Death'] = function(DamageInfo) end
---@param EntryPoint int32
function ABP_Weed_Dandelion_B_C:ExecuteUbergraph_BP_Weed_Dandelion_B(EntryPoint) end
